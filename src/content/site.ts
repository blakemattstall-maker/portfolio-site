    ...
    blocks: [
      {
        ...
        side: "right",
        media: "video",
        slotLabel: "The /graph view settling into clusters, then the 3D globe spinning",
      ...
      },
      {
        ...
        side: "left",
        media: "video",
        slotLabel: "Action Button press, speak a sentence, a task and an expense file themselves",
      ...
      },
      {
        ...
        side: "right",
        media: "photo",
        slotLabel: "The morning brief card, scrolled to show the day",
      ...
      },
      {
        ...
        side: "left",
        media: "photo",
        slotLabel: "An insight card the app surfaced on its own",
