    ...
    blocks: [
      {
        ...
        caption: "Everything I capture becomes a map I can walk. People, projects, money, and notes, all connected from what I told it, never tagged by hand. The way it settles into shape is the thing a screenshot can't show.",
        aspect: "16/9",
      },
      {
        kind: "text",
      ...
      },
      {
        kind: "slot",
        media: "photo",
        label: "An insight card, something the app surfaced on its own",
