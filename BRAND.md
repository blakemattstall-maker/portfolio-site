...
## v2.1 additions (2026-08-16, after Blake's hero/3D direction)
...
- **Static hosting:** Thumb War and its realtime leaderboard were retired in
  September 2026. The portfolio now exports as plain HTML, CSS, and JavaScript
  for Cloudflare Pages and has no server-side requests.
